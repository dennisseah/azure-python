...
from azure_python.services.azure_openai_service import AzureOpenAIService
...
def fn_mock_service(mocker: MockerFixture) -> Callable[[bool], AzureOpenAIService]:
    def wrapper(with_api_key: bool) -> AzureOpenAIService:
        patched_azure_openai = mocker.patch(
            "azure_python.services.azure_openai_service.AsyncAzureOpenAI",
            autospec=True,
        )
        ...
        mocker.patch(
            "azure_python.services.azure_openai_service.DefaultAzureCredential",
